    ...
    <main className="mx-auto min-h-screen relative justify-between flex  mt-8">
      ...
      <div className=" lg:flex hidden flex-col 0 items-start w-1/2 p-5  h-full">
        ...
        <div className="flex flex-col w-full   my-3  ">
          ...
          <Link key={features._id} href={`/projects/${features.slug}`} className="flex flex-col has-before bg-[#1b1b1d] hover:shine hover:mt-5 hover:ml-3 border transition-all duration-150 delay-250  ease-in  w-full px-3 py-4 rounded my-4">
            <h3>{features.name}</h3>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-x-5 group w-full my-3">
          ...
          {projects.map((project) => (
            ...
            <Link key={project._id} href={`/projects/${project.slug}`} className="flex flex-col has-before bg-[#1b1b1d] hover:shine hover:mt-5 hover:ml-3  group-hover:gap-x-2 transition-all duration-150 delay-250  ease-in px-3 py-4 rounded my-4 ">
