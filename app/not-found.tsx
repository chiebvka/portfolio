...
export default function NotFound ()  {
    return(
        ...
        <section className="mx-auto  items-center justify-between flex  mt-8">
            <div className="container flex items-center justify-center min-h-screen border-2 border-red-600 px-6  mx-auto">
                <div className="w-full ">
                    <div className="flex flex-col items-center border-2 border-red-600 mx-auto text-center">
                        <div className="w-full h-96 border-b-4  border-indigo-500 ">
                            <Image  src={profile} className='object-contain bg-transparent flex h-full w-full' alt="Profile Portrait "  />
                        </div>
                        <p className="text-5xl font-medium mt-5 text-[#bebebe]">404 error</p>
                    ...
                    <div className="grid w-full border-2 max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
