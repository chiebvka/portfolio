...
export default function page ()  {
    return (
<div className="relative  mt-[20px] lg:mt-[70px] flex justify-center items-center  h-[80vh] my-auto  from-sky-50 to-gray-200">  
            ...
            <div className="rounded-xl bg-[#1b1b1d] border-2 border-slate-400  shadow-xl">
                <div className="p-4 sm:p-16">
                    <div className="space-y-4 flex lg:flex-row flex-col">
                        <div className="flex lg:w-4/12 w-full lg:h-full  relative">
                    ...
                    <div className="mt-16 grid space-y-4">
                        <Link href="https://github.com/whoisebvka" target='_blank'className="group h-12 px-6 border-2 border-gray-300 rounded-full flex items-center  transition duration-300 hover:border-slate-400 focus:bg-blue-50 active:bg-blue-100">
                        ...
                        <Link href="mailto:ebuka@bexoni.com" target='_blank' className="group h-12 px-6 border-2 border-gray-300 rounded-full flex items-center  transition duration-300  hover:border-slate-400 focus:bg-blue-50 active:bg-blue-100">
                            <div className="relative flex items-center space-x-4 ">
